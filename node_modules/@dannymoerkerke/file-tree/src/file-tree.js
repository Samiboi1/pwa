var CustomElement=function(a){'use strict';class b extends HTMLElement{static get observedAttributes(){return["size"]}constructor(){super();const a=this.attachShadow({mode:"open"});a.innerHTML=`
      <style>
        :host {
          --loader-color: #008000;
          --line-width: 3px;
